...
def run_strategy(df, cidt=False):
    ...
    for idx, row in df.iterrows():
        ...
        if net >= 0:
            # Charging logic (excess generation)
            ...
            if cidt and anticipatory_charge:
                batt_ch *= 1.2  # encourage more storage during cheap times
            ...
            if cidt and anticipatory_charge:
                h2_ch *= 1.1  # slight increase only, prioritise battery
            ...
            # Discharging logic (insufficient generation)
            ...
            if cidt and anticipatory_discharge:
                batt_dis *= 1.3  # slightly more if future price drops, but protect SoC
